...
public class ScheduleController {
	...
	@GetMapping(path = "user/{uid}/schedule/")
	...
	@GetMapping(path = "user/{uid}/schedule/{sid}")
	...
	@PostMapping(path = "user/{uid}/schedule/")
